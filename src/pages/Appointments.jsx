  ...
  return docInfo && (
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border bordergray-400 rounded-lg p-8 py-7bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <p className='text-gray-600 '>Appointment Fee: <span>{currencySymbol}{docInfo.fee}</span></p>
        </div>
      </div>
