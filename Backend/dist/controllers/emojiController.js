...
const sendEmojiPing = async (req, res) => {
    try {
...
const getUndeliveredPings = async (req, res) => {
    try {
        ...
        const pings = await emojiPingModel
            ...
            .limit(20);
        // Mark as delivered
        await emojiPingModel.updateMany({ toUserId: userId, delivered: false }, { delivered: true });
...
//# sourceMappingURL=emojiController.js.map