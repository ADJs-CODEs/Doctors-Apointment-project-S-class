...
import { RiHeartPulseLine, RiSendPlaneFill, RiTempHotLine, RiTimeLine } from '@remixicon/react';
...
const DoctorsAdherenceView = ({ item, expandedId, setSelectedApptId, setShowAlertModal, getAdherenceStats }: DoctorsAdherenceViewProps) => {
  return (
    <AnimatePresence>
