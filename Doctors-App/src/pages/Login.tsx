    ...
    <div className='min-h-[90vh] flex items-center justify-center px-6 py-12 bg-clinic-bg'>
      ...
      >
        ...
        <div className='mb-10 text-center'>
          {/* Rebranded Icon Wrapper */}
          <div className='inline-flex items-center gap-2 px-5 py-2 bg-teal-50 rounded-full text-teal-600 mb-8 border border-teal-100/50'>
            <div className='w-5 h-5 bg-teal-600 rounded-full flex items-center justify-center text-white font-black text-[10px]'>+</div>
            <span className='text-[10px] font-black uppercase tracking-[2.5px]'>ADJ's CODEs Verified</span>
          </div>
        ...
        <div className='grid grid-cols-2 gap-4 mb-8'>
          <button
            ...
            className='flex items-center justify-center gap-3 py-3.5 border border-slate-100 rounded-2xl hover:bg-slate-50 transition-colors text-slate-600 font-black text-[10px] uppercase tracking-wider'
          >
        ...
        <div className='relative mb-8'>
          ...
          <div className='relative flex justify-center text-[9px] uppercase font-black tracking-[3px] text-slate-300'>
            <span className='bg-white px-6'>Official Registry</span>
          </div>
        </div>
        ...
        <form onSubmit={onSubmitHandler} className='space-y-4'>
          {state === 'Sign Up' && (
            <div className='relative group'>
              <input type="text" placeholder="Your Full Name" className='medical-input pl-14 w-full focus:border-teal-600 transition-all' onChange={(e) => setName(e.target.value)} value={name} required />
          ...
          <div className='relative group'>
            <input type="email" placeholder="patient@adjscodes.com" className='medical-input pl-14 w-full focus:border-teal-600 transition-all' onChange={(e) => setEmail(e.target.value)} value={email} required />
          ...
          <div className='relative group'>
            <input type="password" placeholder="Security Password" className='medical-input pl-14 w-full focus:border-teal-600 transition-all' onChange={(e) => setPassword(e.target.value)} value={password} required />
          ...
          <button type='submit' className='btn-primary w-full flex items-center justify-center gap-3 mt-4 bg-slate-900 hover:bg-teal-600 transition-all py-4 text-[10px] font-black uppercase tracking-widest'>
