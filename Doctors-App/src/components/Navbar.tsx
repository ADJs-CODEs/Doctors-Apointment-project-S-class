          ...
          {showMenu && (
            ...
            >
              ...
              <div className='flex items-center justify-between px-8 py-8 border-b border-slate-50 shrink-0'>
                ...
                <div onClick={() => setShowMenu(false)} className='p-2.5 bg-slate-50 rounded-xl cursor-pointer active:scale-90 transition-transform'>
                ...
                <ul className='flex flex-col gap-8'>
                  {['HOME', 'DOCTORS', 'ABOUT', 'CONTACT'].map((item, i) => (
                    ...
                    >
                      ...
                      >
                        <li className='text-5xl font-black tracking-tighter text-slate-800 hover:text-teal-500 transition-all uppercase'>
                          {item}
                        </li>
                      </NavLink>
                    </motion.div>
              ...
              {/* Bottom Info Section */}
              <div className='mt-auto p-10 border-t border-slate-50 bg-slate-50/50 shrink-0'>
                <p className='text-[10px] font-black text-teal-600 uppercase tracking-[4px] mb-3'>Direct Assistance</p>
                <p className='text-2xl font-bold text-slate-900 tabular-nums'>(+234) 704 203 0981</p>
                <div className='mt-6 text-slate-400 text-[9px] font-bold uppercase tracking-widest'>
                  ADJ'S CODES © 2026 • Pharmaceutical Division
                </div>
              </div>
            </motion.div>
          )}
